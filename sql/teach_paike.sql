...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('基础信息', @parentId, '2', 'base', 'teach/paike/base/index', 1, 0, 'C', '0', '0', '', '#', 'admin', sysdate(), null, null, null);
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('智能排课', @parentId, '3', 'intellect', 'teach/paike/intellect/index', 1, 0, 'C', '0', '0', '', '#', 'admin', sysdate(), null, null, null);
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('班级排课时间', @parentId2, '3', 'adminclassTimes', 'teach/paike/intellect/adminclassTimes/index', 1, 0, 'C', '0',
        '0',
        'teach.paike:adminclassTimes', '#', 'admin', sysdate(), '', null, '班级排课时间菜单');
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('教师排课时间', @parentId2, '4', 'teacherTimes', 'teach/paike/intellect/teacherTimes/index', 1, 0, 'C', '0', '0',
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('预排', @parentId2, '6', 'lessonSchedulePre', 'teach/paike/intellect/lessonSchedulePre/index', 1, 0, 'C', '0', '0',
        'teach.paike:lessonSchedulePre', '#', 'admin', sysdate(), '', null, '排课预排菜单');
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('自动排课', @parentId2, '7', 'lessonScheduleAuto', 'teach/paike/intellect/lessonScheduleAuto/index', 1, 0, 'C', '0',
        '0',
        'teach.paike:lessonScheduleAuto', '#', 'admin', sysdate(), '', null, '排课自动排课菜单');
-- 课表调整
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('课表调整', @parentId, '4', 'adjust', 'teach/paike/view/index', 1, 0, 'C', '0', '0', '', '#', 'admin', sysdate(), null, null, null);
...
insert into sys_menu (menu_name, parent_id, order_num, path, component, is_frame, is_cache, menu_type, visible, status,
                      perms, icon, create_by, create_time, update_by, update_time, remark)
values ('查看课表', @parentId, '5', 'view', 'teach/paike/view/index', 1, 0, 'C', '0', '0', '', '#', 'admin', sysdate(), null, null, null);
