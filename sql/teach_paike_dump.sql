my-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
...
INSERT INTO `sys_logininfor` VALUES (100,'admin','127.0.0.1','内网IP','Chrome 11','Windows 10','0','登录成功','2025-05-22 13:28:28'),(101,'admin','127.0.0.1','内网IP','Chrome 11','Windows 10','0','登录成功','2025-05-22 15:47:11'),(102,'admin','127.0.0.1','内网IP','Chrome 13','Windows 10','0','登录成功','2025-05-23 11:37:13'),(103,'admin','127.0.0.1','内网IP','Chrome 11','Windows 10','0','登录成功','2025-05-26 12:22:37'),(104,'admin','127.0.0.1','内网IP','Chrome 11','Windows 10','0','登录成功','2025-05-26 14:00:37'),(105,'admin','127.0.0.1','内网IP','Chrome 11','Windows 10','0','登录成功','2025-08-08 09:40:57'),(106,'admin','127.0.0.1','内网IP','Chrome 11','Windows 10','0','登录成功','2025-08-08 10:21:05');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2028 DEFAULT CHARSET=utf8mb3 COMMENT='菜单权限表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=178 DEFAULT CHARSET=utf8mb3 COMMENT='操作日志记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tpk_classroom` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='班级教室';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tpk_classroom_special` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='特殊教室';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tpk_lesson_plan` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1926887127360741420 DEFAULT CHARSET=utf8mb3 COMMENT='任课信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tpk_lesson_schedule` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `school_id` bigint NOT NULL COMMENT '学校ID',
  `teach_calender_id` bigint NOT NULL COMMENT '学年学期',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1925444731540381699 DEFAULT CHARSET=utf8mb3 COMMENT='排课任务';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tpk_lesson_schedule_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='排课存档';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tpk_lesson_schedule_rule` (
  ...
  `json` text NOT NULL COMMENT '数据',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='排课规则';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1925444755120758786 DEFAULT CHARSET=utf8mb3 COMMENT='作息安排';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ts_grade` (
  ...
  `name` varchar(32) NOT NULL COMMENT '名称',
  `teacher_id` bigint DEFAULT NULL COMMENT '年级组长',
  `deleted` tinyint DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1925458838624751618 DEFAULT CHARSET=utf8mb3 COMMENT='年级';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ts_lesson_time` (
  ...
  `time_index` int DEFAULT NULL COMMENT '节次顺序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1925461024536612874 DEFAULT CHARSET=utf8mb3 COMMENT='上课节次';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ts_teach_calendar` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COMMENT='学年学期';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COMMENT='教师';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-08-08 10:22:18
