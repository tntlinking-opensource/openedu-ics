...
public class ExcelUtil<T> {
    ...
    public AjaxResult importTemplateExcel(List<T> list, String sheetName) {
        this.init(list, sheetName, StringUtils.EMPTY, Type.IMPORT);
        return exportExcel();
    }

    public AjaxResult importTemplateExcel(List<T> list, String sheetName, String title) {
